Initial and Fitted refer to the model parameters in the same order as specified by the likelihood function


CF8_FullAllo_Theta

Sound angle in the world is used to model responses
