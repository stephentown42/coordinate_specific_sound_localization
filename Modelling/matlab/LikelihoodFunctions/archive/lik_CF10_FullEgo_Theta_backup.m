function NegLL = lik_CF10_FullEgo_Theta(response, stim, alpha, x0, invT, critical_angle)
%
% INPUTS
...
%
% alpha - spatial modulation strength
% x0    - bias to peak response probability
% beta  - softmax inverse temperature
% resp_angle_threshold - angle to distinguish between action 1 and 2
%
%
% OUTPUTS
%
...
% Discretize response angle
is_left = @(x, lb)  x >= lb & x < (lb+180);
response = is_left(response, critical_angle) + 1; % Action 1 = right, 2 = left
