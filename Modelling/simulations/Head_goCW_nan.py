...
def main():
    ...
    df['response_activation'] = df['response_angle_world'].map({-90:1, 90:0})
    df['response_activation'].fillna(0.5, inplace=True)
    ...
    #######################################################################################################################
    plt.savefig('Modelling/images/jneurosci/Head_CW_nan.png', dpi=600)
    # plt.show()
